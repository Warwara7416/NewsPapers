...
<div id="getting_started" class="mazino-tab-pane active">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="mazino-info-title text-center"><?php esc_html_e('About the Mazino theme', 'mazino'); ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="mazino-tab-pane-half mazino-tab-pane-first-half">
				<img src="<?php echo esc_url(get_stylesheet_directory_uri()) . '/admin/img/mazino.png'; ?>" alt="<?php esc_attr_e('Quality Theme', 'mazino'); ?>" />
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-md-6">
				<div class="mazino-tab-pane-half mazino-tab-pane-first-half">
					...
					<p class="info-text"><?php echo esc_html__('Lite Demo', 'mazino'); ?></p></a>
					...
					<p class="info-text"><?php echo esc_html__('PRO Demo', 'mazino'); ?></p></a>
				</div>
			</div>
			<div class="col-md-6">
				<div class="mazino-tab-pane-half mazino-tab-pane-first-half">
					...
					<p class="info-text"><?php echo esc_html__('Your feedback is valuable to us', 'mazino'); ?></p></a>
					...
					<p class="info-text"><?php echo esc_html__('Premium Theme Support', 'mazino'); ?></p></a>
				</div>
			</div>
			<div class="col-md-6">
				<div class="mazino-tab-pane-half mazino-tab-pane-first-half">
					...
					<p class="info-text"><?php echo esc_html__('Premium Theme Details', 'mazino'); ?></p></a>
				</div>
			</div>
		</div>
	</div>

...
<section id="section-block" class="news">
		<div class="container">
			...
			<div class="row" id="blog-masonry">
				<?php $mazino_pagedno = (get_query_var('paged')) ? get_query_var('paged') : 1;
				...
				<article class="post" <?php post_class(); ?>>
						...
						<div class="post-content">
							<?php if ($mazino_current_options['home_meta_section_settings'] == '' || $mazino_current_options['home_meta_section_settings'] == false) {?>
							<div class="item-meta">
							...
							<div class="entry-meta">
								...
								<?php $mazino_cat_list = get_the_category_list();
